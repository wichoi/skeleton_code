...
int secc_msg_supported_app_protocol(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_session_setup(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_service_discovery(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_service_detail(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_payment_selection(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_payment_detail(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_authorization(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_charging_parameter(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_power_delivery(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_certificate_update(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_certificate_installation(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_session_stop(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_charging_status(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_metering_receipt(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_current_demand(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
...
int secc_msg_welding_detection(void)
{
    int ret_val = RET_OK;
    log_i("%s\n", __func__);
    return ret_val;
