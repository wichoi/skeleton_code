...
int jRead_int_def(char *pJson, char *pQuery, int *queryParams, int def_val); // add by kkko, 210812
int jRead_int_neg(char *pJson, char *pQuery, int *queryParams); // added by kkko, 210812
